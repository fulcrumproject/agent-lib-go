...
func (_mock *MockFulcrumClient[P, C]) UnsupportedJob(jobID string, errorMessage string) error {
	ret := _mock.Called(jobID, errorMessage)
...
type MockFulcrumClient_UnsupportedJob_Call[P any, C any] struct {
	*mock.Call
}
...
//   - jobID string
//   - errorMessage string
func (_e *MockFulcrumClient_Expecter[P, C]) UnsupportedJob(jobID interface{}, errorMessage interface{}) *MockFulcrumClient_UnsupportedJob_Call[P, C] {
	return &MockFulcrumClient_UnsupportedJob_Call[P, C]{Call: _e.mock.On("UnsupportedJob", jobID, errorMessage)}
}

func (_c *MockFulcrumClient_UnsupportedJob_Call[P, C]) Run(run func(jobID string, errorMessage string)) *MockFulcrumClient_UnsupportedJob_Call[P, C] {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockFulcrumClient_UnsupportedJob_Call[P, C]) Return(err error) *MockFulcrumClient_UnsupportedJob_Call[P, C] {
	_c.Call.Return(err)
	return _c
}

func (_c *MockFulcrumClient_UnsupportedJob_Call[P, C]) RunAndReturn(run func(jobID string, errorMessage string) error) *MockFulcrumClient_UnsupportedJob_Call[P, C] {
	_c.Call.Return(run)
	return _c
}
